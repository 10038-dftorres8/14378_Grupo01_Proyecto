<!-- Modal -->
<div class="modal fade" id="modalFormMisconsultas" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formMisconsultas" name="formMisconsultas" class="form-horizontal">
              <input type="hidden" id="idMisconsultas" name="idMisconsultas" value="">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <input type="hidden" id="listMedicos" name="listMedicos" value="<?php echo $_SESSION['userData']['IdMedico']; ?>">
                </div>
              </div>
...
<!-- Modal -->
<div class="modal fade" id="modalViewMiconsulta" tabindex="-1" role="dialog" aria-hidden="true">
