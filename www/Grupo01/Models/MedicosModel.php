<?php 
	...
	class MedicosModel extends Mysql
	{
		...
		{
	        $sql = "SELECT u.*, m.IdMedico, m.Nombre AS NombreMed FROM usuarios u
		...
		public function selectMedico(int $idpersona){
			...
			$sql = "SELECT m.IdUsuario AS UserMedico,m.IdMedico AS id_user,m.Nombre,m.Especialidad AS Espe, e.Descripcion AS Descripcion,u.Nombre AS User,u.Foto
					FROM medicos m 
