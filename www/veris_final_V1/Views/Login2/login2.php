    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            <label class="control-label">Password - Google Authenticator</label>
            <input id="clave" name="clave" class="form-control" type="password" placeholder="XXXXXX" maxlength="6" minlength="6" required>
          </div>
          <div class="form-group">
            <div class="utility">
